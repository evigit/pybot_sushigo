...
def makeOrder(orderType):
    ...
    while time.time() < ROLLING_COMPLETE and pyautogui.locateOnScreen(imPath('clear_mat.png'), region=(GAME_REGION[0] + 115, GAME_REGION[1] + 295, 220, 175)) is None: # sushi matzone
        time.sleep(0.1)
...
def orderIngredient(ingredient):
    """Do the clicks to purcase an ingredient. updating ORDERING_COMPLETE and INVENTORY(updateInventory())"""
